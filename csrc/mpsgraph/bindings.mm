// MASt3R Runtime - MPSGraph Backend Python Bindings
...
PYBIND11_MODULE(_mpsgraph, m) {
    m.doc() = "MASt3R Runtime MPSGraph Backend (Apple Silicon with native SDPA)";
    ...
    py::class_<PyMPSGraphEngine>(m, "MPSGraphEngine")
        .def(py::init<const std::string&, int, const std::string&, int>(),
             py::arg("variant") = "mast3r_vit_large",
             py::arg("resolution") = 384,
             py::arg("precision") = "fp32",
             py::arg("num_threads") = 4)
        .def("load", &PyMPSGraphEngine::load)
        .def("is_ready", &PyMPSGraphEngine::is_ready)
        .def("name", &PyMPSGraphEngine::name)
        .def("warmup", &PyMPSGraphEngine::warmup, py::arg("num_iterations") = 3)
        .def("infer", &PyMPSGraphEngine::infer)
        .def("match", &PyMPSGraphEngine::match,
             py::arg("desc_1"),
             py::arg("desc_2"),
             py::arg("top_k") = 512,
